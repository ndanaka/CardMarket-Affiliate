  ...
  return (
    <>
      <div className="w-[45%] max-[500px]:w-full">
        ...
        <p className="text-[red] text-3xl font-semibold ">532/700</p>
        <div className=" relative">
          <CircleChart />
          <div className=" absolute top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
            <p className="text-[red] text-xl font-semibold">700 POINTS</p>
            <p>TO REACH DIAMOND</p>
          </div>
        </div>
        <h3 className="py-3 font-semibold">My CurrentLevel</h3>
