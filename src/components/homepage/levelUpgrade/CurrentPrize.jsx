  ...
  return (
    <>
      <div className="w-[45%] max-[500px]:w-full">
        ...
        <p className="text-gray-500 pt-3 text-[14px] text-center">Currently Earning:</p>
        ...
        <p className="text-gray-500 pt-2 text-[14px] text-center">Current Period:</p>
        ...
        <p className="text-gray-500 pt-2 text-[14px] text-center">Points Expire In:</p>
