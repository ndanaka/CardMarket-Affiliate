...
const Links = ({ pageName, ReqId, PageId }) => {
    ...
    return (
        <>
            <div className="font-sans text-gray-700 p-10 max-[1000px]:p-5 bg-gradient-to-t from-[#8080802e] to-white w-[420px] max-[1000px]:w-[350px] max-[500px]:w-[325px] max-[500px]:px-3 shadow-lg 
            drop-shadow-gray-300 hover:-translate-y-1 duration-200">
                ...
                <div className="flex gap-3 py-1 items-center bg-white rounded-sm px-3 ">
                    ...
                    >
                        {copy === 'htmlTag' ? <i className="fa fa-check" /> : <i onClick={() => handleLinkCopy('htmlTag')} className="far fa-copy text-[20px] cursor-copy" />}
                    </div>
                </div>
                ...
                <div className="flex gap-3 py-1 items-center bg-white rounded-sm px-3">
                    ...
                    >
                        {copy === 'url' ? <i className="fa fa-check" /> : <i onClick={() => handleLinkCopy('url')} className="far fa-copy text-[20px] cursor-copy" />}
                    </div>
                </div>
            </div>
            <Tooltip id="htmlTag" />
